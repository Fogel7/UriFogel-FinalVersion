...
const NAV_LINKS = [
    ...
    { key: "jedi", href: "jedi.html", label: "jedi" },
    { key: "sith", href: "sith.html", label: "sith" }
];
...
function renderHeader() {
    ...
    let links = `
        ...
        `;
    if (getFaction() === "jedi") {
        links += `<li><a href="jedi.html" data-nav="jedi">jedi</a></li>`;
    }
    else if (getFaction() === "sith") {
        links += `<li><a href="sith.html" data-nav="sith">sith</a></li>`;
    }
